...
const MUI = (function(t) {
  ...
  function r(t, e, n, i, r, o, s, l, a, u) {
  ...
  const m = ["attrs", "props", "domProps"],
    w = ["class", "style", "directives"],
    E = ["on", "nativeOn"],
    O = function(t, e) {
      return function() {
        ...
        for (const n in e)
          if (t[n])
            if (-1 !== m.indexOf(n)) t[n] = h({}, t[n], e[n]);
              ...
              for (const a in e[n])
                t[n][a] = t[n][a] ? O(t[n][a], e[n][a]) : e[n][a];
            else t[n] = e[n];
          else t[n] = e[n];
        return t;
      }, {});
      ...
      undefined,
      {
        ...
        render: function() {
          ...
          return i.ellipsis
            ? t(
                "el-tooltip",
                y([{}, o, { attrs: { disabled: !r.isEllipsis } }]),
                [t("span", { class: "mui-textEllipsis" }, [n.default])]
              )
            : t("el-tooltip", y([{}, o]), [n.default]);
        }
      },
      undefined,
      undefined,
  ...
  const j = r(
    ...
    I = "1.0.4",
    L = { Dialog: a, Button: p, MultiTag: g, Tooltip: W, Empty: B },
    U = function t(e) {
      const n =
  ...
  "undefined" != typeof window && window.Vue && U(window.Vue),
    console.log("MUI：running version ".concat(I));
  const K = { version: I, install: U };
  return (
    (t.Button = p),
    (t.Dialog = a),
    (t.Empty = B),
