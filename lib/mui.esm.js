...
const script = {
  ...
  methods: {
    close: function close() {
      ...
      const beforeClose = this.$props.beforeClose;
...
const Dialog = _objectSpread2(
  _objectSpread2({}, __vue_component__),
  {},
  {
...
const Button = _objectSpread2(
  _objectSpread2({}, __vue_component__$1),
  {},
  {
    install: function install(Vue) {
...
const MultiTag = _objectSpread2(
  _objectSpread2({}, __vue_component__$2),
  {},
  {
    install: function install(Vue) {
    ...
    return a.reduce(function(c, a) {
      for (const b in a)
        if (!c[b]) c[b] = a[b];
          ...
          const d = c[b] instanceof Array ? c[b] : [c[b]],
            e = a[b] instanceof Array ? a[b] : [a[b]];
          c[b] = d.concat(e);
        } else if (-1 !== functionalMerge.indexOf(b)) {
          for (const f in a[b])
            if (c[b][f]) {
              const g = c[b][f] instanceof Array ? c[b][f] : [c[b][f]],
...
const script$3 = {
  ...
  methods: {
    calcTips: function calcTips() {
      const el = this.$el;
      const clientWidth =
        el === null || el === void 0 ? void 0 : el.clientWidth;
...
const Tooltip = _objectSpread2(
  _objectSpread2({}, __vue_component__$3),
  {},
  {
    install: function install(Vue) {
      ...
      _c(
        ...
        [
          _vm._t("default", [
            ...
            _vm._v(" "),
            _vm.description || _vm.$slots.text
              ? _c(
                  "div",
                  {
...
const Empty = _objectSpread2(
  _objectSpread2({}, __vue_component__$4),
  {},
  {
...
export { Button, Dialog, Empty, MultiTag, Tooltip, install, version };
